...
class FirstAnswerButton: UIButton {
    ...
    override func awakeFromNib() {
        self.addTarget(self, action: #selector(FirstAnswerButton.buttonClicked), for: UIControlEvents.touchUpInside)
        self.touch()
    }
